...
export const App = () => {
  ...
  const renderContent = () => {
    ...
    // 预测性维护
    if (activeTabId === 'pm-0') return <JawCrusherPmView />;
    if (activeTabId === 'pm-1') return <ConeCrusherWearPmView />;
    if (activeTabId === 'pm-2') return <ConeEccentricPmView />;
    if (activeTabId === 'pm-3') return <ImpactCrusherCrackPmView />;
    if (activeTabId === 'pm-4') return <ExciterHealthPmView />;
    if (activeTabId === 'pm-5') return <ScreenBearingPmView />;
    if (activeTabId === 'pm-6') return <ScreenStructurePmView />;
    if (activeTabId === 'pm-7') return <ScreenWearPmView />;
    if (activeTabId === 'pm-8') return <ScreenSystemComparePmView />;
    if (activeTabId === 'pm-9') return <BeltConveyorPmView />;
    if (activeTabId === 'pm-10') return <BeltTearPmView />;
    if (activeTabId === 'pm-11') return <PulleyWearPmView />;
    if (activeTabId === 'pm-12') return <GearboxPmView />;
    if (activeTabId === 'pm-13') return <IdlerFaultPmView />;
    if (activeTabId === 'pm-14') return <HoistHealthPmView />;
    if (activeTabId === 'pm-15') return <HoistRopePmView />;
    if (activeTabId === 'pm-16') return <HoistBrakePmView />;
    if (activeTabId === 'pm-17') return <HoistShaftBearingPmView />;
    if (activeTabId === 'pm-18') return <HoistFailureWindowPmView />;
    if (activeTabId === 'pm-19') return <BallMillHealthPmView />;
    if (activeTabId === 'pm-20') return <BallMillLubePmView />;
    if (activeTabId === 'pm-21') return <BallMillLinerWearPmView />;
    if (activeTabId === 'pm-22') return <FlotationAgitatorPmView />;
    if (activeTabId === 'pm-23') return <ThickenerDrivePmView />;
    if (activeTabId === 'pm-24') return <ShipMainEngineHealthPmView />;
    if (activeTabId === 'pm-25') return <ShipCrankshaftPmView />;
    if (activeTabId === 'pm-26') return <ShipCylinderLinerPmView />;
    if (activeTabId === 'pm-27') return <ShipPistonPmView />;
    if (activeTabId === 'pm-28') return <ShipEngineRiskOverviewPmView />;
    if (activeTabId === 'pm-29') return <ShipEngineFaultProbPmView />;
    if (activeTabId === 'pm-30') return <ShipEngineFailureWindowPmView />;
    if (activeTabId === 'pm-31') return <ShipEngineRulPmView />;
    if (activeTabId === 'pm-32') return <ShipEngineRulConfidencePmView />;
    if (activeTabId === 'pm-33') return <ShipEngineTypicalFailurePmView />;
    if (activeTabId === 'pm-34') return <ShipShaftSystemPmView />;
    if (activeTabId === 'pm-35') return <PropulsionBearingVibTempPmView />;
    if (activeTabId === 'pm-36') return <PropulsionShaftMisalignmentPmView />;
    if (activeTabId === 'pm-37') return <PropellerCrackCorrosionPmView />;
    if (activeTabId === 'pm-38') return <PropulsionDegradationRatePmView />;
    if (activeTabId === 'pm-39') return <ShipAuxGeneratorPmView />;
    if (activeTabId === 'pm-40') return <ShipAuxSystemComparePmView />;
    if (activeTabId === 'pm-41') return <ShipSwitchboardOverheatPmView />;
    if (activeTabId === 'pm-42') return <ShipElectricalLoadPmView />;
    if (activeTabId === 'pm-43') return <ShipElectricalFailureModePmView />;
    if (activeTabId === 'pm-44') return <FuelSystemHealthPmView />;
    if (activeTabId === 'pm-45') return <FuelInjectorDegradationPmView />;
    if (activeTabId === 'pm-46') return <FuelSystemClogLeakPmView />;
    if (activeTabId === 'pm-47') return <LubeDeteriorationPmView />;
    if (activeTabId === 'pm-48') return <LubeSystemRulPmView />;
    if (activeTabId === 'pm-49') return <CoolingWaterPumpPmView />;
    if (activeTabId === 'pm-50') return <SeawaterCoolingPmView />;
    if (activeTabId === 'pm-51') return <HeatExchangerClogPmView />;
    if (activeTabId === 'pm-52') return <CompressedAirPmView />;
    if (activeTabId === 'pm-53') return <ShipAuxSystemComparePmView />;
    if (activeTabId === 'pm-54') return <SteeringGearPmView />;
    if (activeTabId === 'pm-55') return <SteeringPumpActuatorPmView />;
    if (activeTabId === 'pm-56') return <SteeringJamPmView />;
    if (activeTabId === 'pm-57') return <SteeringFailureWindowPmView />;
    if (activeTabId === 'pm-58') return <SteeringRulPmView />;
    if (activeTabId === 'pm-59') return <WinchHealthPmView />;
    if (activeTabId === 'pm-60') return <WinchGearboxBrakePmView />;
    if (activeTabId === 'pm-61') return <HatchCoverPmView />;
    if (activeTabId === 'pm-62') return <MarineCraneSlewingPmView />;
    if (activeTabId === 'pm-63') return <DeckMachineryFailurePmView />;
    if (activeTabId === 'pm-64') return <PortCraneHealthPmView />;
    if (activeTabId === 'pm-65') return <CraneTrolleyPmView />;
    if (activeTabId === 'pm-66') return <RtgTravelPmView />;
    if (activeTabId === 'pm-67') return <LighthousePowerPmView />;
    if (activeTabId === 'pm-68') return <NavMarkRiskPmView />;
    if (activeTabId === 'pm-69') return <HeavyLoadDegradationPmView />;
    if (activeTabId === 'pm-70') return <SevereSeaPropulsionPmView />;
    if (activeTabId === 'pm-71') return <HighSaltCorrosionPmView />;
    if (activeTabId === 'pm-72') return <ExtremeWeatherPmView />;
    if (activeTabId === 'pm-73') return <ContinuousVoyageFatiguePmView />;
    if (activeTabId === 'pm-74') return <MultiShipJointFailurePmView />;
    if (activeTabId === 'pm-75') return <ShipSystemFaultPropagationPmView />;
    if (activeTabId === 'pm-76') return <ShipCascadingFailurePmView />; 
    if (activeTabId === 'pm-77') return <PortCallMaintenancePmView />;
    if (activeTabId === 'pm-78') return <ShippingComprehensivePmView />;
