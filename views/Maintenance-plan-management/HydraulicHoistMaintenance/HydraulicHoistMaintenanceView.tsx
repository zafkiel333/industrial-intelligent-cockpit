...
// MODEL_LIB_LINK[mpm-8]: 2026-07-09 新增，占位模型库地址；
...
export const HydraulicHoistMaintenanceView: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white tracking-wider">液压启闭机系统维保</h1>
        <p className="text-slate-400 mt-2">智能维保管理系统 / 实时监控与调度</p>
      </div>
      
      <div className="flex flex-col gap-6 h-full">
        <SciFiCard title="3D 实时监控视图 - 液压启闭机系统维保" className="h-[400px]">
