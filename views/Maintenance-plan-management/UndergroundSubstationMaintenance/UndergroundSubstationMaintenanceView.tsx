...
import { ThreeScene } from '../../../components/Maintenance-plan-management/UndergroundSubstationMaintenance/ThreeScene';
// 2026-07-09 新增：模型库跳转链接（场景库测试方案 8.4）
import { ModelLibraryLink } from '../../../src/scenarioLib/ModelLibraryLink';
// MODEL_LIB_LINK[mpm-25]: 2026-07-09 新增，占位模型库地址；
// 模型库正式上线后，只需把下面这一行的 url 改成真实地址即可，其余逻辑不用动。
const MODEL_LIB_URL = 'https://industrial-intelligent-cockpit.example.com/model-lib/models/mpm-25';
...
export const UndergroundSubstationMaintenanceView: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white tracking-wider">井下中央变电所预防性检修</h1>
        <p className="text-slate-400 mt-2">智能维保管理系统 / 实时监控与调度</p>
      </div>
      
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        <div className="space-y-6">
          <SciFiCard title="现场监控" className="h-[200px]">
            <CameraWidget name="CAM-01" status="online" />
          </SciFiCard>
          <SciFiCard title="风险预警" className="h-[250px] overflow-y-auto">
            <RiskWidget risks={mockRisks} />
          </SciFiCard>
          <SciFiCard title="技术文档" className="h-[250px] overflow-y-auto">
            <DocumentWidget docs={mockDocs} />
          </SciFiCard>
        </div>
        <div className="lg:col-span-2">
          <SciFiCard title="井下中央变电所预防性检修 - 核心场景" className="h-full min-h-[740px]">
        ...
        <div className="space-y-6">
          <SciFiCard title="运行参数" className="h-[400px] overflow-y-auto">
            <ParameterWidget params={mockParams} />
          </SciFiCard>
          <SciFiCard title="资源保障" className="h-[315px] overflow-y-auto">
