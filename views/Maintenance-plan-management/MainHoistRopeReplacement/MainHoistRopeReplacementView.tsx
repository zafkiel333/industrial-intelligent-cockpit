...
import { ThreeScene } from '../../../components/Maintenance-plan-management/MainHoistRopeReplacement/ThreeScene';
// 2026-07-09 新增：模型库跳转链接（场景库测试方案 8.4）
import { ModelLibraryLink } from '../../../src/scenarioLib/ModelLibraryLink';
// MODEL_LIB_LINK[mpm-20]: 2026-07-09 新增，占位模型库地址；
// 模型库正式上线后，只需把下面这一行的 url 改成真实地址即可，其余逻辑不用动。
const MODEL_LIB_URL = 'https://industrial-intelligent-cockpit.example.com/model-lib/models/mpm-20';
...
export const MainHoistRopeReplacementView: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white tracking-wider">主井提升机钢丝绳更换</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-2">
          <SciFiCard title="主井提升机钢丝绳更换 - 核心场景" className="h-full min-h-[740px]">
