...
import { ThreeScene } from '@/components/vibration-monitoring/ShipAirConditioning/ThreeScene';
const ShipAirConditioningView: React.FC = () => {
  return (
    <div className="p-6 space-y-6 overflow-y-auto h-full tech-grid-bg">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-cyan-400 tracking-wider">船舶中央空调风机盘管异常震动</h1>
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-4 space-y-6">
          ...
          <SciFiCard title="频谱分析摘要"><div className="text-sm text-slate-400 leading-relaxed">系统实时监测船舶中央空调风机盘管异常震动的震动频率分布。当前主频稳定，未发现异常。</div></SciFiCard>
        </div>
      </div>
    </div>
  );
};
export default ShipAirConditioningView;
