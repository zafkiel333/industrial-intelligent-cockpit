  ...
  return (
    <div className="p-6 space-y-6 overflow-y-auto h-full tech-grid-bg">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-cyan-400 tracking-wider">船舶舵机液压冲击震动监测</h1>
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-4 space-y-6">
          ...
          <SciFiCard title="频谱分析摘要"><div className="text-sm text-slate-400 leading-relaxed">系统实时监测船舶舵机液压冲击震动监测的震动频率分布。当前主频稳定，未发现异常。</div></SciFiCard>
        </div>
      </div>
    </div>
  );
