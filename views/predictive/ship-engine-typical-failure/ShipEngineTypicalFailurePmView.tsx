...
// MODEL_LIB_LINK[pm-pmOther-33]: 2026-07-13 新增，占位模型库地址；
// 模型库正式上线后，只需把下面这一行的 url 改成真实地址即可，其余逻辑不用动。
const MODEL_LIB_URL = 'https://industrial-intelligent-cockpit.example.com/model-lib/models/pm-pmOther-33';
import { 
...
import { 
  ...
  // Fix: Added missing AlertTriangle and ShieldCheck to resolve "Cannot find name" errors
...
export const ShipEngineTypicalFailurePmView: React.FC = () => {
    ...
    return (
        <div className="flex flex-col h-full gap-4 text-slate-100 font-[Rajdhani] select-none bg-[#020617]">
            ...
            {/* --- 系统状态页脚 --- */}
            <div className="h-10 bg-rose-950/20 border-t border-rose-500/20 px-6 flex items-center justify-between z-20">
