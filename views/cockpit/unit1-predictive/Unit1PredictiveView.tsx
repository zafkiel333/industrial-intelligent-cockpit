      ...
      <div className="flex flex-col xl:flex-row gap-4 flex-none xl:h-[45vh] min-h-[400px]">
        ...
        <div className="unit1-predictive-visual-shell xl:w-1/3 border border-slate-800 rounded-lg overflow-hidden relative shadow-lg min-h-[300px] xl:min-h-0">
           ...
           <div className="absolute top-4 left-4 right-4 flex justify-between pointer-events-none">
              <div className="unit1-predictive-inspection-panel px-3 py-1 rounded border text-xs flex items-center gap-2">
                <span className="unit1-predictive-inspection-label">当前检视:</span>
                <span
                  className="unit1-predictive-inspection-time font-mono"
           ...
           <div className="unit1-predictive-timeline-panel absolute bottom-4 left-4 right-4 p-3 rounded border pointer-events-auto">
              <div className="flex justify-between items-center mb-3">
                 <span className="unit1-predictive-timeline-help text-[10px] tracking-wider">时间轴: 拖拉以穿越历史与预测域</span>
                 <span
                   className="unit1-predictive-timeline-counter text-[10px] font-mono px-2 py-0.5 rounded border"
                   data-mode={isPrediction ? 'prediction' : 'history'}
                 >
              ...
              <input 
                ...
                className="unit1-predictive-timeline-range w-full accent-blue-500 h-1.5 rounded-lg appearance-none cursor-pointer"
              />
              <div className="unit1-predictive-timeline-scale flex justify-between text-[10px] mt-2 font-mono">
                 <span className="unit1-predictive-timeline-start">历史起</span>
                 <span className="unit1-predictive-timeline-current">当前计算 ({historyDividerIndex})</span>
                 <span className="unit1-predictive-timeline-end">预测末</span>
              </div>
           </div>
        </div>
