...
import { initExpertScene, animateExpertScene } from './HydroExpertBuilder';
...
export const ThreeScene: React.FC<ThreeSceneProps> = ({ step }) => {
  ...
  useEffect(() => {
    ...
    const animatables: ExpertAnimatables = {};
    const disposables: { dispose: () => void }[] = [];
    
    initExpertScene(group, animatables, disposables);
    ...
    const animate = () => {
      ...
      time += 0.02;
      controls.update();
      animateExpertScene(animatables, step, time);
