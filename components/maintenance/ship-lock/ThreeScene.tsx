...
export const ThreeScene: React.FC<ThreeSceneProps> = ({ state }) => {
  ...
  useEffect(() => {
    ...
    camera.position.set(0, 20, 35); // High angle view
    camera.lookAt(0, 0, 0);
    ...
    const tealLight = new THREE.PointLight(0x14b8a6, 5, 30);
    ...
    const animatables: ShipLockAnimatables = {};
    ...
    const animate = () => {
      ...
      controls.update();
      animateShipLockScene(animatables, state, time);
