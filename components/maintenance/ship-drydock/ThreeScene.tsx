...
import { initDockScene, animateDockScene } from './DryDockBuilder';
...
export const ThreeScene: React.FC<ThreeSceneProps> = ({ phase }) => {
  ...
  useEffect(() => {
    ...
    const animatables: DockAnimatables = {};
    const disposables: { dispose: () => void }[] = [];
    
    initDockScene(group, animatables, disposables);
    ...
    const animate = () => {
      ...
      time += 0.02;
      controls.update();
      animateDockScene(animatables, phase, time);
