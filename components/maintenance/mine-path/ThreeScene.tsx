...
import { initPathScene, animatePathSim } from './PathSimBuilder';
...
export const ThreeScene: React.FC<ThreeSceneProps> = ({ state }) => {
  ...
  useEffect(() => {
    ...
    const animatables: PathAnimatables = {};
    const disposables: { dispose: () => void }[] = [];
    
    initPathScene(group, animatables, disposables);
    ...
    const animate = () => {
      ...
      time += 0.02;
      controls.update();
      animatePathSim(animatables, state, time);
