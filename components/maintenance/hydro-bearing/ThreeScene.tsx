...
import { initBearingScene, animateBearingScene } from './BearingBuilder';
...
export const ThreeScene: React.FC<ThreeSceneProps> = ({ phase, wearLevel }) => {
  ...
  useEffect(() => {
    ...
    initBearingScene(group, animatables, disposables);
    ...
    const animate = () => {
      ...
      controls.update();
      animateBearingScene(animatables, phase, wearLevel, time);
