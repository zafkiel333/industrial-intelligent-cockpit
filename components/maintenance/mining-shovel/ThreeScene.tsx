...
import { initShovelScene, animateShovelScene } from './ShovelBuilder';
...
export const ThreeScene: React.FC<ThreeSceneProps> = ({ state }) => {
  ...
  useEffect(() => {
    ...
    const amberLight = new THREE.PointLight(0xf59e0b, 5, 30);
    ...
    const animatables: ShovelAnimatables = {};
    const disposables: { dispose: () => void }[] = [];
    
    initShovelScene(group, animatables, disposables);
    ...
    const animate = () => {
      ...
      time += 0.02;
      controls.update();
      animateShovelScene(animatables, state, time);
