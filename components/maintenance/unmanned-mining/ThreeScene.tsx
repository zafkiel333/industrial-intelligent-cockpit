...
import { initUnmannedScene, animateUnmannedScene } from './UnmannedMiningBuilder';
...
export const ThreeScene: React.FC<ThreeSceneProps> = ({ phase }) => {
  ...
  useEffect(() => {
    ...
    const animatables: UnmannedAnimatables = {};
    const disposables: { dispose: () => void }[] = [];
    
    initUnmannedScene(group, animatables, disposables);
    ...
    const animate = () => {
      ...
      time += 0.02;
      controls.update();
      animateUnmannedScene(animatables, phase, time);
