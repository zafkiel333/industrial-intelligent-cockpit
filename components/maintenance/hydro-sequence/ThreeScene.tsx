...
import { initSequenceScene, animateSequence } from './SequenceSimBuilder';
...
export const ThreeScene: React.FC<ThreeSceneProps> = ({ phase }) => {
  ...
  useEffect(() => {
    ...
    const animatables: SequenceAnimatables = {};
    const disposables: { dispose: () => void }[] = [];
    
    initSequenceScene(group, animatables, disposables);
    ...
    const animate = () => {
      ...
      time += 0.02;
      controls.update();
      animateSequence(animatables, phase, time);
