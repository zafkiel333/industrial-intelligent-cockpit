...
import { initSimScene, animateSimScene } from './ComparisonSimBuilder';
...
export const ThreeScene: React.FC<ThreeSceneProps> = ({ scenario }) => {
  ...
  useEffect(() => {
    ...
    const animatables: ComparisonSimAnimatables = {};
    const disposables: { dispose: () => void }[] = [];
    
    initSimScene(group, animatables, disposables);
    ...
    const animate = () => {
      ...
      time += 0.02;
      controls.update();
      animateSimScene(animatables, scenario, time);
