...
import { initShipPowerScene, animateShipPowerScene } from './ShipPowerBuilder';
...
export const ThreeScene: React.FC<ThreeSceneProps> = ({ state }) => {
  ...
  useEffect(() => {
    ...
    const animatables: ShipPowerAnimatables = {};
    const disposables: { dispose: () => void }[] = [];
    
    initShipPowerScene(group, animatables, disposables);
    ...
    const animate = () => {
      ...
      controls.update();
      animateShipPowerScene(animatables, state, time);
