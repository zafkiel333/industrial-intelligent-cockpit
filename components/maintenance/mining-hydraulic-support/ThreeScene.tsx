...
import { initHydraulicSupportScene, animateHydraulicScene } from './HydraulicSupportBuilder';
...
export const ThreeScene: React.FC<ThreeSceneProps> = ({ state }) => {
  ...
  useEffect(() => {
    ...
    const animatables: HydraulicAnimatables = {};
    const disposables: { dispose: () => void }[] = [];
    
    initHydraulicSupportScene(group, animatables, disposables);
    ...
    const animate = () => {
      ...
      time += 0.02;
      controls.update();
      animateHydraulicScene(animatables, state, time);
