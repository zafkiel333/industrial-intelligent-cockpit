...
import { initAgingScene, animateAgingScene } from './AgingAssetBuilder';
...
export const ThreeScene: React.FC<ThreeSceneProps> = ({ phase }) => {
  ...
  useEffect(() => {
    ...
    const orangeLight = new THREE.PointLight(0xf59e0b, 5, 20);
    ...
    const animatables: AgingAnimatables = {};
    const disposables: { dispose: () => void }[] = [];
    
    initAgingScene(group, animatables, disposables);
    ...
    const animate = () => {
      ...
      time += 0.02;
      controls.update();
      animateAgingScene(animatables, phase, time);
