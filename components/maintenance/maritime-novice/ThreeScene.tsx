...
import { initNoviceScene, animateNoviceScene } from './NoviceTrainingBuilder';
...
export const ThreeScene: React.FC<ThreeSceneProps> = ({ phase }) => {
  ...
  useEffect(() => {
    ...
    const animatables: NoviceAnimatables = {};
    const disposables: { dispose: () => void }[] = [];
    
    initNoviceScene(group, animatables, disposables);
    ...
    const animate = () => {
      ...
      time += 0.02;
      controls.update();
      animateNoviceScene(animatables, phase, time);
