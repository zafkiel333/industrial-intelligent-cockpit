...
import { initJointScene, animateJointScene } from './JointMaintBuilder';
...
export const ThreeScene: React.FC<ThreeSceneProps> = ({ scenario }) => {
  ...
  useEffect(() => {
    ...
    const animatables: JointAnimatables = {};
    const disposables: { dispose: () => void }[] = [];
    
    initJointScene(group, animatables, disposables);
    ...
    const animate = () => {
      ...
      time += 0.02;
      controls.update();
      animateJointScene(animatables, scenario, time);
