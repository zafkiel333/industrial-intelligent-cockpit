...
import { initShoalScene, animateShoalScene } from './ShoalSceneBuilder';
...
export const ThreeScene: React.FC<ThreeSceneProps> = ({ mode }) => {
  ...
  useEffect(() => {
    ...
    const animatables: ShoalAnimatables = {};
    const disposables: { dispose: () => void }[] = [];
    
    initShoalScene(group, animatables, disposables);
    ...
    const animate = () => {
      ...
      time += 0.02;
      controls.update();
      animateShoalScene(animatables, mode, time);
