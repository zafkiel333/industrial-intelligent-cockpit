...
export const PAGE_MODEL_BINDINGS = [
  ...
  {"viewId":"eq-5","modelId":2304,"pageTitle":"污水处理智能运维","modelName":"工业污水处理设备","grade":"A","fileSize":"3.93 MiB","adaptation":"直接匹配","note":"完整设备平台比单泵更符合污水处理页面；保留水质与核心设备指标。"},
  {"viewId":"eq-7","modelId":2374,"pageTitle":"船舶智能运维","modelName":"集装箱船","grade":"A","fileSize":"3.79 MiB","adaptation":"直接匹配","note":"彩色整船、甲板和集装箱层次清楚；现有主机、航行与海况指标可直接承接。"},
  ...
  {"viewId":"ia-ship-cii","modelId":2373,"pageTitle":"船舶碳强度指标 CII 评级分析","modelName":"集装箱式远航跨洋货轮","grade":"B","fileSize":"2.82 MiB","adaptation":"增加航线工况和 CII 等级颜色联动。"},
