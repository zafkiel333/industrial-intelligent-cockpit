...
2026-08-21 最新状态：场景库 Release `20260821-120215` 已上线，直接回滚版本为 `20260821-112458`。本版把“零部件寿命预警”前十页重做为数字化寿命管理工作台，补齐原先只有菜单项、没有页面实现的“励磁系统功率模块寿命预警”和“油压装置压力容器疲劳监测”，场景背景总检查量更新为 305 个。双构建、导航/HTTPS/寿命预警专项验证、3103 独立端口预检、场景库公网 HTTPS/HTTP、独立版、微应用版、主 JS 与 API 均通过。详细证据见 `云端更新执行记录-20260821-零部件寿命预警前十页重做.md`。此前模型详情消息 Origin 的主平台热修及分类“首页”子菜单整改仍待主平台团队完成。
...
2026-08-21 Release `20260821-120215` 成功切换并完成技术验收后：
