...
2026-08-21 最新状态：场景库 Release `20260821-084944` 已上线，回滚版本为 `20260820-201251`。本版把“1号机组异常预测分析”3D 视窗左上“当前检视”和底部时间轴改为冷调浅灰蓝信息牌配深蓝灰文字，并为历史/预测计数提供淡蓝/淡琥珀状态底；双构建、3103 预检、现网 HTTPS/嵌入入口和公开 CSS 内容检查均通过。HTTP 8081 兼容入口继续保留。此前模型详情消息 Origin 的主平台热修仍待主平台团队发布，分类“首页”子菜单整改也仍待联合验收。
...
2026-08-21 Release `20260821-084944` 成功切换并完成技术验收后：

```text
current  → /nlplabProj/scene-library/releases/20260821-084944
previous → /nlplabProj/scene-library/releases/20260820-201251
```

健康检查返回：

```json
{"status":"ok","version":"20260821-084944"}
```
